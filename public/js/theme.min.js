...
!function () {
    ...
    null !== (e = document.querySelector('[data-bs-toggle="mode"]')) && (t = e.querySelector(".form-check-input"), "dark" === mode ? (root.classList.add("dark-mode"), t.checked = !0) : (root.classList.remove("dark-mode"), t.checked = !1), e.addEventListener("click", function (e) {
    ...
    }(), null !== document.querySelector(".rellax") && new Rellax(".rellax", {horizontal: !0}), function () {
        ...
        var r;
        if (t.dataset.swiperId === 'swiper-apps') {
            r = options
        } else if (t.dataset.swiperId === 'help-aside') {
            r = asideOptions
        }
        ...
        var a = _objectSpread(_objectSpread({}, r), a), a = new Swiper(t, a);
        ...
        for (var n = document.querySelectorAll(".range-slider"), o = 0; o < n.length; o++) !function () {
            var e = n[o].querySelector(".range-slider-ui"), r = n[o].querySelector(".range-slider-value-min"),
                a = n[o].querySelector(".range-slider-value-max"), t = {
        ...
        if (0 !== a.length) for (var n = 0; n < a.length; n++) !function () {
        ...
        if (null !== r) for (var o = 0; o < r.length; o++) {
            var e = function () {
                n = new Shuffle(r[o], {
        ...
        if (null !== e) {
            for (var l = 0; l < e.length; l++) !function () {
                var t = e[l].querySelector('button[type="submit"]'), r = t.innerHTML,
                    a = e[l].querySelector(".form-control"), n = e[l].querySelector(".subscription-form-antispam"),
        ...
        if (0 !== v.length) for (var e = function () {
            var t = v[y], r = t.querySelector("audio"), e = t.querySelector(".ap-play-button"),
                a = t.querySelector(".ap-seek-slider"), n = t.querySelector(".ap-volume-slider"),
                o = t.querySelector(".ap-duration"), l = t.querySelector(".ap-current-time"), i = "play", s = null;
            ...
            function u(e) {
                var t = Math.floor(e / 60), e = ((e = Math.floor(e % 60)) < 10 ? "0" : "").concat(e);
